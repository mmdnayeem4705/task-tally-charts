...
export const TaskList = ({
  ...
  return (
    <Card className="glass-card">
      <CardHeader className="pb-2 space-y-3 p-3 md:p-6">
        ...
        <div className="flex items-center gap-2">
          {!isViewingToday && (
            <History className="w-3 h-3 sm:w-4 sm:h-4 text-muted-foreground" />
          )}
          <div>
      ...
      <CardContent className="space-y-4 p-3 md:p-6 pt-0">
        ...
        <div className="flex items-center gap-2 mb-3 md:mb-4">
          ...
          <span className="text-xs sm:text-sm font-medium">Daily Tasks</span>
          {!isViewingToday && (
